...
insert into public.authorities (
  ...
  ((select id from public.authority_corpora where version = 'sg-employment-restraints-2026.09-pilot.1'), '[2007] SGCA 53', '2007SGCA53', 'Man Financial (S) Pte Ltd v Wong Bark Chuan David', 'Court of Appeal', '2007-11-30', 'https://www.elitigation.sg/gdviewer/s/2007_SGCA_53', 'research_verified'),
  ((select id from public.authority_corpora where version = 'sg-employment-restraints-2026.09-pilot.1'), '[2010] SGCA 3', '2010SGCA3', 'CLAAS Medical Centre Pte Ltd v Ng Boon Ching', 'Court of Appeal', '2010-01-28', 'https://www.elitigation.sg/gd/s/2010_SGCA_3', 'research_verified'),
  ((select id from public.authority_corpora where version = 'sg-employment-restraints-2026.09-pilot.1'), '[2019] SGHC 96', '2019SGHC96', 'HT SRL v Wee Shuo Woon', 'High Court', '2019-04-16', 'https://www.elitigation.sg/gdviewer/s/2019_SGHC_96', 'research_verified'),
  ((select id from public.authority_corpora where version = 'sg-employment-restraints-2026.09-pilot.1'), '[2024] SGHC 29', '2024SGHC29', 'Shopee Singapore Pte Ltd v Lim Teck Yong', 'High Court', '2024-02-01', 'https://www.elitigation.sg/gdviewer/s/2024_SGHC_29', 'research_verified')
